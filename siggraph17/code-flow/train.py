...
def train(model, dataset, optimizer, epoch, now):
...
if __name__ == '__main__':
	...
	dataset = DataLoader(data_loader, batch_size=1, num_workers=6, shuffle=True)
	...
	for epoch in range(epoch_, args.epochs):
		...
		total_loss = train(model, dataset, optimizer, epoch, now)
